...
<table>
	<tr><td colspan="12" style="font-style:italic; text-align:center">Action: <?php echo $action; ?> </td></tr>
	<tr><th colspan="12"><?php echo $captions['question']; ?></th></tr>

	<tr>
	<td style="text-align:right;width:33%"><?php echo $captions['least']; ?></td>
		<?php for ($j = 1; $j <= 10; $j++) { ?>
		<td class="tick"><input type="radio" name="<?php echo "q" . ($number+1) . "_" . $captions['type'];?>" value=<?php echo $j ?> <?php if($j==5) echo "CHECKED"; ?> /></td>
		<?php } ?>
...
<?php function askPersonalInfo() {?>
	<div id="personalinfo">
		...
		<ol>
			...
			<li>What is your gender? <br/><input type="radio" name="gender" value="M">Male</input><input type="radio" name="gender" value="F">Female</input></li>
